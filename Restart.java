...
public class Restart extends Text
{
    ...
    public void act() 
    {
       ...
       //GreenfootImage image=new GreenfootImage("Restart", 45, Color.WHITE, transparent, Color.BLACK);
       GreenfootImage image = new GreenfootImage(getImage());
       GreenfootImage text = new GreenfootImage("Restart", 43, Color.WHITE, transparent, Color.BLACK);
